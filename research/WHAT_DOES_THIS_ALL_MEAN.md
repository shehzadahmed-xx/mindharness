...
## A complete synthesis of the reflexive dynamic loop, the five organs, and where agency lies
...
## Appendix: Applied Example — TikTok, Reels, and the Loop That Programs You While You Program It

*Added 2026-08-30 to keep research folder in sync with `ALGORITHM_PROGRAMMING_BRAIN_TIKTOK_REELS.md`. No new claims, only applied example.*

It is programming you while you are programming it. TikTok and Reels are not feeds you watch. They are loops you are inside, and both sides are learning at the same time.

You program it with every linger, replay, like, share, or swipe away. Those micro actions are labels. Fast memory learns your current session, tired or curious. Slow memory learns your long term profile, the kind of sensor you are. It programs you because every video you watch is a rehearsal. What fires together wires together. A short video that makes you feel inadequate fires a pathway, myelin wraps it a little tighter, and next time that pathway wins faster. After a thousand short videos you do not have a thought that you are inadequate. You have a highway that makes that thought the default winner.

You linger, it learns to show more like that, you watch more like that, you wire more like that, you become a more predictable sensor for like that, it shows more like that. Output becomes input. Map becomes territory. That is why it feels like it knows you, but only as the trace of what kept you.
...
Full field manual: `ALGORITHM_PROGRAMMING_BRAIN_TIKTOK_REELS.md`.
