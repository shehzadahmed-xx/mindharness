...
- Case: **C4 — Kenya railway levy securitisation and future-revenue sovereignty**
- Scenario: **opaque_high_priority_securitisation**
...
|---|---:|
| round_num | 3 |
| legitimacy | 0.5099999999999999 |
| service_continuity | 0.79 |
| public_loss | 0.0 |
| inequality | 0.5412500000000001 |
| trust | 0.38750000000000007 |
| verified_consensus | 0.25 |
| contaminated_consensus | 0.25 |
| active_edges | 3575 |
...
|---:|---|---|---:|---:|---|
| 1 | phased_hybrid_finance | strict_ring_fence | Yes | 0.0000 | cadCAD.Executor |
| 2 | phased_hybrid_finance | strict_ring_fence | Yes | 0.0000 | cadCAD.Executor |
| 3 | phased_hybrid_finance | strict_ring_fence | Yes | 0.0000 | cadCAD.Executor |
